...
//    } completion:^(BOOL finished) {
////        self.hidden = YES;
////        [self.inputViewController dismissViewControllerAnimated:NO completion:nil];
//
//    }];
    
    
    if ([self.delegate respondsToSelector:@selector(menuVCdismiss)])
     {
         [self.delegate menuVCdismiss];
     }
