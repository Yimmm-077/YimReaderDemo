...
{
    headerView.frame = CGRectMake(0, self.topLayoutGuide.length, [UIScreen mainScreen].bounds.size.width,0);
    _titleBackground.frame = CGRectMake(0, (headerView.frame.size.height)?headerView.frame.origin.y+headerView.frame.size.height:self.topLayoutGuide.length, [UIScreen mainScreen].bounds.size.width,40.0);
...
//        _titleBackground.contentSize = CGSizeMake([UIScreen mainScreen].bounds.size.width, _titleBackground.frame.size.height);

    }
    _pageViewController.view.frame = CGRectMake(0, _titleBackground.frame.origin.y+_titleBackground.frame.size.height, [UIScreen mainScreen].bounds.size.width, self.view.frame.size.height-(_titleBackground.frame.origin.y+_titleBackground.frame.size.height));
}
...
-(UIScrollView *)titleBackground
{
    if (!_titleBackground) {
        ...
        _titleBackground.frame = CGRectMake(0,0, [UIScreen mainScreen].bounds.size.width,40.0);
